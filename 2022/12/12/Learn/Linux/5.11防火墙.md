...
# systemctl disable firewalld       # 取消开机启动`复制
...
`# firewall-cmd --permanent --add-rich-rule="rule family='ipv4' source address='222.222.222.222' reject"`复制
